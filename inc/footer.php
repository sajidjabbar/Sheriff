        ...
        <div class="container">
            <div class="row">
                ...
                <div class="col-md-33">
                    <div class="for-useful-links">
                        <ul class="links-without-heading">
                            <li class="the-footer-links"><a href="">Current Grants</a></li>
                            <li class="the-footer-links"><a href="">Divisions</a></li>
                            <li class="the-footer-links"><a href="">Agency Staff</a></li>
                        </ul>
                    </div>
                </div>
            </div>
